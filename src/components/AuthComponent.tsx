...
export function AuthComponent({
  ...
  return (
    <div className="w-full max-w-md mx-auto bg-gray-800 rounded-2xl shadow-xl border border-gray-700 overflow-hidden">
      <div className="p-8">
        {/* Header */}
        <div className="text-center mb-8">
          ...
          <p className="text-gray-400 mt-2">{getSubtitleText()}</p>
        </div>
          ...
          <Else>
            <form onSubmit={handleSubmit}>
                  ...
                  <div className="mb-8">
                    <div className="grid grid-cols-1 gap-3">
                      <button
                        ...
                        disabled={isLoading}
                        className="flex items-center justify-center px-4 py-3 border border-gray-600 rounded-lg hover:bg-gray-700 transition-colors disabled:opacity-50 font-sans"
                      >
                    ...
                    <div className="relative my-6">
                      ...
                      <div className="relative flex justify-center text-sm">
                        <span className="px-2 bg-gray-800 text-gray-400 font-sans">
                    ...
                    <div>
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          className={`w-full pl-10 pr-4 py-3 bg-gray-700 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors outline-none font-sans ${
                    ...
                    <div>
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          className={`w-full pl-10 pr-12 py-3 bg-gray-700 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors outline-none font-sans ${
                            errors.password
                              ? 'border-red-500'
                              : 'border-gray-600'
                          } text-white placeholder-gray-400`}
                      ...
                      {errors.password && (
                        <p className="mt-1 text-sm text-red-400 font-sans">
                          {errors.password}
                        </p>
                      )}
                    </div>
                    ...
                    <div>
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          className={`w-full pl-10 pr-4 py-3 bg-gray-700 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors font-sans ${
                            errors.forgotEmail
                              ? 'border-red-500'
                              : 'border-gray-600'
                          } text-white placeholder-gray-400`}
                    ...
                    <div>
                      ...
                      <div className="relative">
                        <input
                          ...
                          onChange={e =>
                            handleInputChange('twoFACode', e.target.value)
                          }
                          className={`w-full px-4 py-3 bg-gray-700 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors text-center text-2xl tracking-widest font-sans ${
                            errors.twoFACode
                              ? 'border-red-500'
                              : 'border-gray-600'
                          } text-white placeholder-gray-400`}
              ...
              <button
                ...
                className="w-full mt-6 bg-blue-500 text-white py-3 px-4 rounded-lg font-medium hover:bg-blue-600 focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:ring-offset-gray-800 transition-colors disabled:bg-gray-600 disabled:cursor-not-allowed"
              >
          ...
          <If condition={mode === 'register'}>
            <Then>
              <button
                ...
                className="flex items-center justify-center text-sm text-blue-400 hover:text-blue-300 transition-colors font-sans"
              >
