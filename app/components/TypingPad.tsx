...
export function TypingPad(props: TypingPadProps) {
  ...
  useEffect(() => {
    if (testState === 'complete') {
      ...
      if (selectedTest) {
        DAO.update({
          ...selectedTest,
          elapsed: elapsed + get(selectedTest, 'elapsed', 0),
        })
      }
  ...
  }, [testState, elapsed, selectedTest, onReset, continuousMode, randomMode, onRandomize, dispatch, selectNext]);
  ...
  return (
    <div>
      <div className="flex justify-between items-center">
        ...
        <div className="flex gap-4">
          ...
          <Tooltip
            ...
            delayDuration={500}
          >
            <IconButton variant={continuousMode ? "solid" : "soft"} onClick={() => setContinuousMode(curr => !curr)}>
      ...
      >
        ...
        />
        <div
          className={"row-start-1 col-start-1 leading-normal overflow-hidden text-opacity-50 whitespace-pre pointer-events-none font-code text-white caret-lime-400"}
          style={{ fontSize }}
        >
          {code}
        </div>
