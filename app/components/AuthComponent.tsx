...
type AuthComponentMode = 'login' | 'register' | 'forgot' | '2fa';
      ...
      <div className="p-8">
        ...
        <div className="space-y-6">
          ...
          <button
            ...
            className="w-full bg-blue-600 dark:bg-blue-500 text-white py-3 px-4 rounded-lg font-medium hover:bg-blue-700 dark:hover:bg-blue-600 focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 dark:focus:ring-offset-gray-800 transition-colors disabled:bg-gray-400 dark:disabled:bg-gray-600 disabled:cursor-not-allowed"
          >
            {isLoading ? (
          ...
          <div className="flex flex-col space-y-3 text-center">
            ...
            <If condition={mode === 'forgot' || mode === '2fa'}>
              <Then>
                <button
                  type="button"
                  onClick={() => setMode('login')}
